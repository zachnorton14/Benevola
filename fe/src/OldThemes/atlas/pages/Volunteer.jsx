...
import Shell, {
  Avatar, Btn, Chip, Crumbs, Field, Input, Panel, State, Skeleton, Toast,
} from '../parts';
    ...
    <Shell>
      ...
      <div className="atl-shell">
        ...
        <div className="atl-profile">
          ...
          <div style={{ minWidth: 0 }}>
            {editing ? (
              ...
              <h1 className="atl-h1" style={{ marginBottom: 2 }}>{name}</h1>
            )}
        ...
        <div className="atl-cols">
          <div>
            <h2 className="atl-h2" style={{ marginBottom: 12 }}>Upcoming shifts</h2>
            {u.eventsLoading ? (
              <Skeleton rows={3} />
            ) : u.events.length === 0 ? (
              <State title="Nothing booked yet">
                <Link className="atl-link" to="/events">Find something happening this week</Link>
              </State>
            ) : (
          ...
          <aside className="atl-aside">
            <Panel pad>
              <h3 className="atl-h3" style={{ marginBottom: 12 }}>Account</h3>
              ...
              {editing ? (
                ...
                <dl style={{ margin: 0 }}>
                  <div className="atl-kv"><dt>Username</dt><dd>@{user.username}</dd></div>
                  <div className="atl-kv"><dt>Email</dt><dd>{user.email || '—'}</dd></div>
                  <div className="atl-kv"><dt>Shifts booked</dt><dd>{u.events.length}</dd></div>
                </dl>
              )}
            </Panel>
          </aside>
